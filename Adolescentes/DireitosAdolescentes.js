...
function dadosfirstbox(){
    window.location.href="VideosAdolescentes.html" //ao carregar no botão vai para a página "VideosCriancas.html"
}

function dadossecondbox(){
    window.location.href="ArtigosDireitosAdolescentes.html" //ao carregar no botão vai para a página "ArtigosCriancas.html"
}