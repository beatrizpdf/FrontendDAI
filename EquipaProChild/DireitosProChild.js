...
function dadosfirstbox(){
    window.location.href="VideosProChild.html" //ao carregar no botão vai para a página "VideosCrianças.html"
}

function dadossecondbox(){
    window.location.href="ArtigosDireitosProChild.html" //ao carregar no botão vai para a página "ArtigosCrianças.html"
}