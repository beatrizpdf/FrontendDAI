...
function dadosfirstbox(){
    window.location.href="VideosInstituicoes.html" //ao carregar no botão vai para a página "VideosCriancas.html"
}

function dadossecondbox(){
    window.location.href="ArtigosDireitosInstituicoes.html" //ao carregar no botão vai para a página "ArtigosCriancas.html"
}